/*
 * 文件名: fun.cpp
 * 创建日期: 2024-06-17 12:15:25
 * 更新日期：2024-06-19 22:34:25
...
double sin_approx_degrees(double degrees, int terms )
{
    ...
    {
        return -cos_approx_degrees((radians + (PI / 2)) * (180.0 / PI), terms);
    }
    else
    {
        return cos_approx_degrees((radians - (PI / 2)) * (180.0 / PI), terms);
...
double cos_approx_degrees(double degrees, int terms )
{
    ...
    {
        return sin_approx_degrees((radians + (PI / 2)) * (180.0 / PI), terms);
    }
    else
    {
        return -sin_approx_degrees((radians - (PI / 2)) * (180.0 / PI), terms);
